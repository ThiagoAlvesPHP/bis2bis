            ...
            <div class="collapse navbar-collapse" id="navbarSupportedContent">
                <ul class="navbar-nav ms-auto mb-2 mb-lg-0">
                    <?php if (empty($_SESSION['user'])) : ?>
                        <li class="nav-item">
                            <a class="nav-link active" aria-current="page" href="<?= BASE; ?>register">
                                Cadastre-se
                            </a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link active" aria-current="page" href="<?= BASE; ?>login">
                                Login
                            </a>
                        </li>
                    <?php endif; ?>
                    <?php if (!empty($_SESSION['user_data']) && $_SESSION['user_data']['master']) : ?>
                        <li class="nav-item">
                    ...
                    <?php if (!empty($_SESSION['user'])) : ?>
                        <li class="nav-item">
                            <a class="nav-link" title="Logout" href="<?= BASE; ?>profile">
